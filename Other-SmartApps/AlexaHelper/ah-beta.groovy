    ...
    dynamicPage(name: "pageSettings", title: "Settings", install: false, uninstall: false) {	
        section {
            input "speakerSonos", "bool", title: "Allow Sonos special options", defaultValue: false, submitOnChange:true
                if (speakerSonos){
                    input "memoryCount", "enum", title: "Maximun number of Sonos memory slots", options: [2,3,4,5,6,7,8], defaultValue: 2, required: false
                }
...
private def textVersion() {
    def version = "Parent App Version: 4.2.0 (02/03/2016)"
    def childCount = childApps.size()
